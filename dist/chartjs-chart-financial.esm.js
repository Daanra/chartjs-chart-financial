 ...
 */
import { Chart, Element, BarController, defaults } from 'chart.js';
import { valueOrDefault, merge, clipArea, unclipArea, isNullOrUndef } from 'chart.js/helpers';
...
class CandlestickElement extends FinancialElement {
	draw(ctx) {
		...
		let borderColor;
		if (close < open) {
			borderColor = valueOrDefault(borderColors ? borderColors.up : undefined, globalOpts$2.elements.candlestick.borderColor);
			ctx.fillStyle = valueOrDefault(me.color ? me.color.up : undefined, globalOpts$2.elements.candlestick.color.up);
		} else if (close > open) {
			borderColor = valueOrDefault(borderColors ? borderColors.down : undefined, globalOpts$2.elements.candlestick.borderColor);
			ctx.fillStyle = valueOrDefault(me.color ? me.color.down : undefined, globalOpts$2.elements.candlestick.color.down);
		} else {
			borderColor = valueOrDefault(borderColors ? borderColors.unchanged : undefined, globalOpts$2.elements.candlestick.borderColor);
			ctx.fillStyle = valueOrDefault(me.color ? me.color.unchanged : undefined, globalOpts$2.elements.candlestick.color.unchanged);
		}

		ctx.lineWidth = valueOrDefault(me.borderWidth, globalOpts$2.elements.candlestick.borderWidth);
		ctx.strokeStyle = valueOrDefault(borderColor, globalOpts$2.elements.candlestick.borderColor);
...
CandlestickElement.defaults = merge({}, [globalOpts$2.elements.financial, {
